...
{
    float3 mapNormal = tex2D(normalSampler, texCoord).rgb * 2.0f - 1.0f; // transform from [0,1] to [-1,1]
...
technique FXComposerTest {
  pass OnePointLight {
    ...
    PixelShader = compile ps_2_0 PS_TexturedOneDirOrPointLight(true/*useNormalMap*/, true/*useSpecularMap*/, false/*useEmissiveMap*/, /*firstPass*/true, /*pointLight*/true, lightPosition1, diffuseColor1, specularColor1, ambientColor1, attenuation1);
  }
}
