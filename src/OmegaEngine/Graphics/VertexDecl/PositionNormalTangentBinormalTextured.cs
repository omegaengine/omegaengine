...
/// <summary>
/// A custom vertex format that stores position, normals, tangents, binormals and texture coordinates.
...
public struct PositionNormalTangentBinormalTextured(Vector3 position, Vector3 normal, Vector3 tangent, Vector3 binormal, float tu, float tv)
{
    ...
    public override string ToString() => $"{nameof(PositionNormalTangentBinormalTextured)}(position={Position}, normal={Normal}, tu={Tu}, tv={Tv}, tangent={Tangent}, binormal={Binormal})";
    ...
    [
        ...
        // Tangent
        new(0, sizeof(float) * 8, DeclarationType.Float3, DeclarationMethod.Default, DeclarationUsage.Tangent, 0),
        // Binormal
        new(0, sizeof(float) * 11, DeclarationType.Float3, DeclarationMethod.Default, DeclarationUsage.Binormal, 0),
        // End
