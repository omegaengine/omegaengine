...
namespace OmegaEngine.Graphics.Renderables
{
    ...
    public class CpuParticleSystem : PositionableRenderable
    {
        ...
        protected override void OnEngineSet()
        {
            ...
            var vertexes = new[]
            {
                new PositionTextured(new(-0.5f, 0.5f, 0), 0, 0),
                new PositionTextured(new(0.5f, 0.5f, 0), 1, 0),
                new PositionTextured(new(-0.5f, -0.5f, 0), 0, 1),
                new PositionTextured(new(0.5f, -0.5f, 0), 1, 1)
            };
