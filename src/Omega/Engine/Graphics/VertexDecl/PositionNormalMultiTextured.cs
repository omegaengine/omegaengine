...
namespace OmegaEngine.Graphics.VertexDecl
{
    ...
    public struct PositionNormalMultiTextured
    {
        ...
        public PositionNormalMultiTextured(Vector3 position, Vector3 normal, float tu, float tv, float lightRiseAngle, float lightSetAngle, float[] texWeights, Color color)
        {
