...
public class ImportHeightMap(ITerrain terrain, string fileName, Action refreshHandler)
    : ImportMap<ByteGrid>(terrain, fileName, refreshHandler + (() => terrain.OcclusionIntervalMapOutdated = true))
{
