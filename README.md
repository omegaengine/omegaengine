...
- [Visual Studio 2022 v17.13 or newer](https://www.visualstudio.com/downloads/) (build-time dependency)
...
**[Frame of Reference](src/FrameOfReference/README.md)** is the official sample game for the OmegaEngine. It is [included in the OmegaEngine source code](src/FrameOfReference/) but is not a part of the released library binaries.
