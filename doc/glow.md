...
> [!TIP]
> The [asset management system](xref:OmegaEngine.Assets#texture-name-convention) automatically discovers certain texture maps based on a naming convention. To make a glow map discoverable, append `_glow` to the name of the corresponding diffuse texture and keep the original file extension.
>
> **Example:**  
